...
import (
	httpCatalog "github.com/YasiruR/go-connector/api/gateway/http/catalog"
	httpNegotiation "github.com/YasiruR/go-connector/api/gateway/http/negotiation"
	httpTransfer "github.com/YasiruR/go-connector/api/gateway/http/transfer"
