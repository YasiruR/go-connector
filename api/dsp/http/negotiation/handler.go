...
func (h *Handler) GetNegotiation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		middleware.WriteError(w, errors.PathParamNotFound(negotiation.RequestEndpoint, api.ParamProviderPid),
	...
	if err != nil {
		middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleProvider, negotiation.RequestEndpoint,
...
func (h *Handler) HandleContractRequest(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleProvider, endpoint, err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleContractOffer(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleConsumer, endpoint, err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleContractAgreement(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleConsumer, negotiation.ContractAgreementEndpoint,
			err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleAgreementVerification(w http.ResponseWriter, r *http.Request) {
	...
	if err := middleware.ParseRequest(r, &req); err != nil {
		middleware.WriteError(w, errors.ParseRequestFailed(negotiation.AgreementVerificationEndpoint, err),
			http.StatusBadRequest)
		return
	}
	...
	if err != nil {
		middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleProvider, negotiation.AgreementVerificationEndpoint,
			err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleNegotiationEvent(w http.ResponseWriter, r *http.Request) {
	...
	case negotiation.EventAccepted:
		...
		if err != nil {
			middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleProvider, negotiation.EventsEndpoint,
				err), http.StatusBadRequest)
			return
		}
		middleware.WriteAck(w, ack, http.StatusOK)
	case negotiation.EventFinalized:
		...
		if err != nil {
			middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleConsumer, negotiation.EventsEndpoint,
				err), http.StatusBadRequest)
			return
		}
		middleware.WriteAck(w, ack, http.StatusOK)
...
func (h *Handler) HandleTermination(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		middleware.WriteError(w, ror.DSPHandlerFailed(core.RoleProvider, negotiation.TerminateEndpoint,
			err), http.StatusBadRequest)
		return
	}
