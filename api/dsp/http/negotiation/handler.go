...
func (h *Handler) GetNegotiation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.sendError(w, errors.HandlerFailed(negotiation.RequestEndpoint, dsp.RoleProvider, err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleContractRequest(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.sendError(w, errors.HandlerFailed(negotiation.ContractRequestEndpoint, dsp.RoleProvider, err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleContractAgreement(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.sendError(w, errors.HandlerFailed(negotiation.ContractAgreementEndpoint, dsp.RoleConsumer, err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleAgreementVerification(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.sendError(w, errors.HandlerFailed(negotiation.AgreementVerificationEndpoint, dsp.RoleProvider, err), http.StatusBadRequest)
		return
	}
...
func (h *Handler) HandleEventConsumer(w http.ResponseWriter, r *http.Request) {
	...
	case negotiation.EventFinalized:
		...
		if err != nil {
			h.sendError(w, errors.HandlerFailed(req.ConsPId, dsp.RoleConsumer, err), http.StatusBadRequest)
			return
		}
