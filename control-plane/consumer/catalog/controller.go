...
func (c *Controller) RequestCatalog(endpoint string) (catalog.Response, error) {
	...
	if err != nil {
		...
		return catalog.Response{}, errors.Client(errors.ProtocolFailed(control_plane.CatalogProtocol, catErr, err))
	}
...
func (c *Controller) RequestDataset(id, endpoint string) (catalog.DatasetResponse, error) {
	...
	if err != nil {
		...
		return catalog.DatasetResponse{}, errors.Client(errors.ProtocolFailed(control_plane.CatalogProtocol, catErr, err))
	}
